...
# Tiered item lists with escalating prices and better efficiency/stats
HUNT_ITEMS = [
...
class FullEconomyCog(commands.Cog):
    ...
    async def economyhelp(self, ctx):
        ...
        embed.add_field(name="🛠️ Admin Only", value="`.normalize` - Reset/normalize economy tables (Owner Only)", inline=False)
